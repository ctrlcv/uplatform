...
class SignUpNormalByUPlatformPage extends StatefulWidget {
  const SignUpNormalByUPlatformPage({Key? key}) : super(key: key);

  static const routeName = '/SignUpNormalByUPlatformPage';

  @override
  _SignUpNormalByUPlatformPageState createState() => _SignUpNormalByUPlatformPageState();
}

class _SignUpNormalByUPlatformPageState extends State<SignUpNormalByUPlatformPage> {
  final _formKey = GlobalKey<FormState>(debugLabel: 'SignUpNormalByUPlatformPage');
