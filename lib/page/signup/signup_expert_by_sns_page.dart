...
class SignUpExpertBySnsPage extends StatefulWidget {
  const SignUpExpertBySnsPage({Key? key}) : super(key: key);

  static const routeName = '/SignUpExpertBySnsPage';

  @override
  _SignUpExpertBySnsPageState createState() => _SignUpExpertBySnsPageState();
}

class _SignUpExpertBySnsPageState extends State<SignUpExpertBySnsPage> {
  final _formKey = GlobalKey<FormState>(debugLabel: 'SignUpExpertBySnsPage');
                    ...
                    Container(
                      ...
                      child: BorderRoundedButton(
                        ...
                        onPressed: () async {
                          ...
                          debugPrint("SignUpNormalByUPlatformPage() 휴대폰인증 isSuccess $certificationSuccess");
